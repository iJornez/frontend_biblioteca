<template>
  <v-card class="mx-auto" max-width="900" elevation="15">
    <v-img src="https://img.freepik.com/fotos-premium/computadora-portatil-moderna-monitor-blanco-blanco-lugar-pagina-su-sitio-web-mesa-madera-clara-taza-cafe-cuaderno-negro-boligrafo-fondo-borroso-oficina-maqueta-representacion-3d_688884-26.jpg"
      height="350px"></v-img>
