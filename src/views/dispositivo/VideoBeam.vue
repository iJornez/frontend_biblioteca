<template>
  <v-card class="mx-auto" max-width="900" elevation="15">
    <v-img src="https://cdn.create.vista.com/api/media/small/10236068/stock-photo-projector-on-the-ceiling"
      height="350px"></v-img>

    <v-card-title class="crear"> Crear Video Beam </v-card-title>
